...
Este repositorio contiene el proyecto **Radio Alura** del curso **"Java: Aplicando la Orientación a Objetos"** impartido por **Genesys Rondón Merchán** a través de **Alura Latam**. En este curso, profundicé en los principios fundamentales de la programación orientada a objetos (POO) utilizando Java, mejorando mis habilidades en modelado de aplicaciones a través de clases, atributos y métodos.
...
- **Encapsulamiento**: Protección de los datos y control de acceso a los mismos.

Como parte del proyecto, desarrollé **Radio Alura**, una aplicación que pone en práctica todos estos conceptos. El proyecto consiste en una herramienta para organizar y gestionar un sistema de audio/música, donde se puede realizar tareas como reproducir canciones, cambiar estaciones y gestionar listas de reproducción. 
...
3. Ejecuta el archivo `Principal.java` como aplicación Java que se encuentra en el package `com.aluracursos.radioalura.principal`.
...
- Desarrollo de una aplicación práctica de gestión de audio/música.
